 ...
 */
class EDCC extends \TRC\CoreBundle\Entity\Client\EDCC implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'TRC\\CoreBundle\\Entity\\Client\\EDCC' . "\0" . 'id', '' . "\0" . 'TRC\\CoreBundle\\Entity\\Client\\EDCC' . "\0" . 'numeroCompte', '' . "\0" . 'TRC\\CoreBundle\\Entity\\Client\\EDCC' . "\0" . 'type', '' . "\0" . 'TRC\\CoreBundle\\Entity\\Client\\EDCC' . "\0" . 'solde', '' . "\0" . 'TRC\\CoreBundle\\Entity\\Client\\EDCC' . "\0" . 'client'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (EDCC $proxy) {
