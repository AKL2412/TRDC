 ...
 */
class Etat extends \TRC\CoreBundle\Entity\Etat implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'TRC\\CoreBundle\\Entity\\Etat' . "\0" . 'id', '' . "\0" . 'TRC\\CoreBundle\\Entity\\Etat' . "\0" . 'phase'];
        }
