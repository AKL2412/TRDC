...
class EDCC extends \TRC\CoreBundle\Entity\Client\EDCC implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'TRC\\CoreBundle\\Entity\\Client\\EDCC' . "\0" . 'id', '' . "\0" . 'TRC\\CoreBundle\\Entity\\Client\\EDCC' . "\0" . 'numeroCompte', '' . "\0" . 'TRC\\CoreBundle\\Entity\\Client\\EDCC' . "\0" . 'solde'];
        }
