 ...
 */
class BOC extends \TRC\CoreBundle\Entity\BOC implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'TRC\\CoreBundle\\Entity\\BOC' . "\0" . 'id', '' . "\0" . 'TRC\\CoreBundle\\Entity\\BOC' . "\0" . 'nom', '' . "\0" . 'TRC\\CoreBundle\\Entity\\BOC' . "\0" . 'matricule', '' . "\0" . 'TRC\\CoreBundle\\Entity\\BOC' . "\0" . 'description', '' . "\0" . 'TRC\\CoreBundle\\Entity\\BOC' . "\0" . 'dateajout', '' . "\0" . 'TRC\\CoreBundle\\Entity\\BOC' . "\0" . 'code', '' . "\0" . 'TRC\\CoreBundle\\Entity\\BOC' . "\0" . 'entite'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (BOC $proxy) {
