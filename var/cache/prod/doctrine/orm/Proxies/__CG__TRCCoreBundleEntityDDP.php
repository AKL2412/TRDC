...
class DDP extends \TRC\CoreBundle\Entity\DDP implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'TRC\\CoreBundle\\Entity\\DDP' . "\0" . 'id', '' . "\0" . 'TRC\\CoreBundle\\Entity\\DDP' . "\0" . 'min', '' . "\0" . 'TRC\\CoreBundle\\Entity\\DDP' . "\0" . 'max', '' . "\0" . 'TRC\\CoreBundle\\Entity\\DDP' . "\0" . 'description'];
        }
