 ...
 */
class Zone extends \TRC\CoreBundle\Entity\Zone implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'TRC\\CoreBundle\\Entity\\Zone' . "\0" . 'id', '' . "\0" . 'TRC\\CoreBundle\\Entity\\Zone' . "\0" . 'nom', '' . "\0" . 'TRC\\CoreBundle\\Entity\\Zone' . "\0" . 'matricule', '' . "\0" . 'TRC\\CoreBundle\\Entity\\Zone' . "\0" . 'description', '' . "\0" . 'TRC\\CoreBundle\\Entity\\Zone' . "\0" . 'dateajout', '' . "\0" . 'TRC\\CoreBundle\\Entity\\Zone' . "\0" . 'code', '' . "\0" . 'TRC\\CoreBundle\\Entity\\Zone' . "\0" . 'entite'];
        }
