 ...
 */
class Systeme extends \TRC\CoreBundle\Entity\Systeme implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'TRC\\CoreBundle\\Entity\\Systeme' . "\0" . 'id', '' . "\0" . 'TRC\\CoreBundle\\Entity\\Systeme' . "\0" . 'nom', '' . "\0" . 'TRC\\CoreBundle\\Entity\\Systeme' . "\0" . 'code', '' . "\0" . 'TRC\\CoreBundle\\Entity\\Systeme' . "\0" . 'description', '' . "\0" . 'TRC\\CoreBundle\\Entity\\Systeme' . "\0" . 'dateajout', '' . "\0" . 'TRC\\CoreBundle\\Entity\\Systeme' . "\0" . 'matricule', '' . "\0" . 'TRC\\CoreBundle\\Entity\\Systeme' . "\0" . 'acteur'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Systeme $proxy) {
