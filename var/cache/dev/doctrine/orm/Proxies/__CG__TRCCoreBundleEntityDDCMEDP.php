 ...
 */
class MEDP extends \TRC\CoreBundle\Entity\DDC\MEDP implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'TRC\\CoreBundle\\Entity\\DDC\\MEDP' . "\0" . 'id', '' . "\0" . 'TRC\\CoreBundle\\Entity\\DDC\\MEDP' . "\0" . 'dateposte', '' . "\0" . 'TRC\\CoreBundle\\Entity\\DDC\\MEDP' . "\0" . 'message', '' . "\0" . 'TRC\\CoreBundle\\Entity\\DDC\\MEDP' . "\0" . 'edp', '' . "\0" . 'TRC\\CoreBundle\\Entity\\DDC\\MEDP' . "\0" . 'fichier', '' . "\0" . 'TRC\\CoreBundle\\Entity\\DDC\\MEDP' . "\0" . 'fonction'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (MEDP $proxy) {
    ...
    public function setDateposte($dateposte)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setDateposte', [$dateposte]);

        return parent::setDateposte($dateposte);
    }
    ...
    public function getDateposte()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getDateposte', []);

        return parent::getDateposte();
    }
