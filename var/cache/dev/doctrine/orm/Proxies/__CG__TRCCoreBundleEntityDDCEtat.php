 ...
 */
class Etat extends \TRC\CoreBundle\Entity\DDC\Etat implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'TRC\\CoreBundle\\Entity\\DDC\\Etat' . "\0" . 'id', '' . "\0" . 'TRC\\CoreBundle\\Entity\\DDC\\Etat' . "\0" . 'code', '' . "\0" . 'TRC\\CoreBundle\\Entity\\DDC\\Etat' . "\0" . 'description', '' . "\0" . 'TRC\\CoreBundle\\Entity\\DDC\\Etat' . "\0" . 'phase', '' . "\0" . 'TRC\\CoreBundle\\Entity\\DDC\\Etat' . "\0" . 'nom', '' . "\0" . 'TRC\\CoreBundle\\Entity\\DDC\\Etat' . "\0" . 'decision'];
        }
