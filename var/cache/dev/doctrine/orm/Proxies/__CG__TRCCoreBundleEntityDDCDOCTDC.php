 ...
 */
class DOCTDC extends \TRC\CoreBundle\Entity\DDC\DOCTDC implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'TRC\\CoreBundle\\Entity\\DDC\\DOCTDC' . "\0" . 'id', '' . "\0" . 'TRC\\CoreBundle\\Entity\\DDC\\DOCTDC' . "\0" . 'dateajout', '' . "\0" . 'TRC\\CoreBundle\\Entity\\DDC\\DOCTDC' . "\0" . 'nom', '' . "\0" . 'TRC\\CoreBundle\\Entity\\DDC\\DOCTDC' . "\0" . 'tdc'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (DOCTDC $proxy) {
