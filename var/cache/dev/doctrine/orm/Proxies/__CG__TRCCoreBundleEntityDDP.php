 ...
 */
class DDP extends \TRC\CoreBundle\Entity\DDP implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'TRC\\CoreBundle\\Entity\\DDP' . "\0" . 'id', '' . "\0" . 'TRC\\CoreBundle\\Entity\\DDP' . "\0" . 'min', '' . "\0" . 'TRC\\CoreBundle\\Entity\\DDP' . "\0" . 'max', '' . "\0" . 'TRC\\CoreBundle\\Entity\\DDP' . "\0" . 'description', '' . "\0" . 'TRC\\CoreBundle\\Entity\\DDP' . "\0" . 'tdc', '' . "\0" . 'TRC\\CoreBundle\\Entity\\DDP' . "\0" . 'fonction'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (DDP $proxy) {
    ...
    public function addTdc(\TRC\CoreBundle\Entity\DDC\TDC $tdc)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'addTdc', [$tdc]);

        return parent::addTdc($tdc);
    }
    ...
    public function removeTdc(\TRC\CoreBundle\Entity\DDC\TDC $tdc)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'removeTdc', [$tdc]);

        return parent::removeTdc($tdc);
    }
